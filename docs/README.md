...
- **Different monsters** - Monsters only exist on platforms and there are 3 types of them: goblins, zombies and ghosts. Each type has a different way of moving and does distinct amounts of damage.
